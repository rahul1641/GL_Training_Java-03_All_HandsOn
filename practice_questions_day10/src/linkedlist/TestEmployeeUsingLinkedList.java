...
//Q.2.) Implement above question 1 using Linked List.
...
class EmployeeDB{
	...
	public boolean addEmployee(Employee e) {
		System.out.println("Employee Added in the linked list");
		return list.add(e);
	}
	...
	public boolean deleteEmployee(int empId) {
		...
		while(itr.hasNext()) {
			...
			if(e.getEmpId() == empId) {
				itr.remove();
				System.out.println("Employee "+empId+ " Removed from the linked list");
				flag = true;
			}
		}
		return flag;
	 ...
	 public String showPaySlip(int empId) {
		 ...
		 String res ="Employee ID " +empId+ " not exists in the linked list can't show the Salaryslip !!";
		 Iterator<Employee> itr = list.iterator();
...
public class TestEmployeeUsingLinkedList {
	...
	public static void main(String[] args) {
		...
		System.out.println("LinkedList will look like this after adding employees--->");
		...
		System.out.println("LinkedList will look like this if Employees are removed--->");
