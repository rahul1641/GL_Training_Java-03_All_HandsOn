...
//Q.3.) Implement above question 1 using Vector.
...
class EmployeeDB{
	...
	public static Vector<Employee> vect = new Vector<>();
	...
	public boolean deleteEmployee(int empId) {
		...
		boolean flag = false;
		Iterator<Employee> itr = vect.iterator();
		...
		while(itr.hasNext()) {
			...
			if(e.getEmpId() == empId) {
				itr.remove();
				System.out.println("Employee "+empId+ " Removed from the vector");
				flag = true;
			}
		}
		return flag;
	 ...
	 public String showPaySlip(int empId) {
		 ...
		 String res ="Employee ID " +empId+ " not exists in the vector can't show the Salaryslip !!";
		 Iterator<Employee> itr = vect.iterator();
...
public class TestEmployeeUsingVector {
	...
	public static void main(String[] args) {
		...
		System.out.println("Vector will look like this after adding employees--->");
		Iterator<Employee> it = EmployeeDB.vect.iterator();
		while(it.hasNext()) {
		...
		System.out.println("Vector will look like this if Employees are removed--->");
		Iterator<Employee> it1 = EmployeeDB.vect.iterator();
		while(it1.hasNext()) {
